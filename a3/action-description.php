...
?>
  ...
  <nav>
    ...
    <div id="navLinks">
      ...
      <a href="action-description.php" class="active">Action Description</a>
      <li>
        <a href="javascript:void(0);" onclick= "togglePage('page1', 'page')">
          An Account of the Gallipoli Landing
        </a>
        <a href="javascript:void(0);" onclick= "togglePage('page2', 'page')">
          The "Big Push"
        </a>
        <a href="javascript:void(0);" onclick= "togglePage('page3', 'page')">
          Battle of Poziers
        </a>
      </li>
  ...
  <main class="container">
    ...
    <section id="page1">
      <div class="letter">
        <h4> An Account of the Gallipoli Landing. </h4>
        <h5> Fort Tigne Hospital, Malta, May 4th 1915. </h5>
        <p>
          Dear Mother,
        </p>
        <p>
    ...
    <section id="page3">
      <div class="letter">
        ...
        <p>
          It is the Sabbath day and for a wonder we are having a rest so I have time to write a few lines
          while reclining in my billet which at some remote period was a fowl-house.  But we are accustomed
          to all sorts of conditions now and learn to make the best of things however severe they may be.
          For some time now we have been on the move from one village to another, rarely stopping at one place
          for more than a few days.  We see a great deal of the country but would enjoy it more if we had less
          to carry.
        </p>

        <p>
          Of course you will have read much about the Australians being in the “Big Push” but the papers could not
          convey any idea of the real truth of such hellish fighting as we were in at Pozieres.  I have written to
          Mother three times since I came out and hope the letters arrived alright, giving her some sort of an account
          of things. Our fellows have fought marvellously well, gaining all their objectives but at a great cost and the
          casualty lists, if published in the Australian papers will be a great blow to the people.  Our Division
          [the 1st] which was the first of the Australians to take part in the push had about 9,000 casualities and
          the 2nd Division suffered just as much.  For the few days we were in it, it was hell on earth, practically no sleep,
          little to eat and shells of all sorts and all sizes being pelted at us day and night.
        </p>

        <p>
          Dead and wounded lay on all sides and there was blood everywhere, in one part of the trench where there had been hand to hand fighting, we noticed
          among the dead an Australian, his hands gripping a German by the throat while the latter had his arms around the other’s body – both were dead, had been
          killed by a bomb while struggling together.  The many sights we saw would make your blood curdle, they were too awful for me to describe, but there were
          many heroic incidents which made me feel glad that I am British.  Our bombers for instance did great work.  On the second morning of our stunt the Huns were
          holding a bit of trench that we wanted and they were very hard to shift, so the officer of the bombers spoke to his men, “Will we shift them, lads?”,
          “Right ho, sir” was the answer and they hopped out over the parapet, 20 or 30 of them, in the face of shells and machine gun fire, raced across to the
          enemy trench and standing there in broad daylight they pelted their bombs with great coolness.  It was a great bit of work and we kept up machine gun
          fire over their heads during the scrap.  The trench was won, most of the occupants being killed, and of course, our chaps suffered too.  This is only one
          little incident, the stretcher bearers toiled and sweated for all they were worth under very severe conditions. Our Coy had sixteen guns in action and the
          only one we lost was the one I was on – the Hun’s artillery had the range to a T and lobbed over gas shells, tear shells, high explosives, shrapnel, etc. from
          18 pounders to 9.2 inch.  It was “No Bon”.  Our team consisted of 5 men and 1 officer.  The officer and 1 man were wounded and 2 men killed.  It was hard luck
          but such things are to be expected.
        </p>

        <p>
          Well anyway, dear Herb, all that is over now and we are satisfied that things can be no worse.  The 4th Division are now in and we may relieve them soon.  At present
          we are at the village of Bonneville waiting for orders, having a quiet time so – what’s the use of worrying as long as we are in good health..  I hope all at home
          are in the best of health also, yourself and the girls. I have written to Mrs. McCathie, you will hear the news from her not included here.  I will also be writing
          home again soon.  Fancy you saying – “Vouley-vous promenade, mademoiselle.”  She might reply, “Oui monsier, merci.”  Tres Bon, eh?  I hope Will Raymond and family are
          well, give them my love and also remember me to any other friends.  Could you let me know if home affairs are settled up yet and how Mother is and the girls.  I am
