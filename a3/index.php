...
<?php top_module("ANZAC Douglas Raymond Baker"); ?>
  <main class="container">
    ...
    <footer>
      ...
      </script> Luke Smith, S3807720. <a href="https://github.com/S3807720/wp" target="blank"> Github repo</a>. Last modified <?= date ("Y F d  H:i", filemtime($_SERVER['SCRIPT_FILENAME'])); ?>.</div>
